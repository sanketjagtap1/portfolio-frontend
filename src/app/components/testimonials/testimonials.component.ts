    ...
    <section class="py-20 bg-gradient-to-br from-slate-900 via-slate-900 to-slate-950 text-white relative overflow-hidden">
      ...
      <div class="container mx-auto px-4 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div class="group" data-aos="zoom-in" data-aos-delay="100">
            <div class="relative">
              ...
              <div class="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/20 shadow-xl hover:shadow-blue-500/25 transition-all duration-500 hover:-translate-y-2">
                ...
                <p class="text-blue-100 leading-relaxed mb-6">
                  "Sanket delivered an exceptional e-commerce platform that exceeded our expectations. 
                  His attention to detail and technical expertise made the project a huge success."
                </p>
                ...
                <div class="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div class="text-sm text-blue-200">CEO, TechCorp</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="group" data-aos="zoom-in" data-aos-delay="200">
            <div class="relative">
              ...
              <div class="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/20 shadow-xl hover:shadow-cyan-500/25 transition-all duration-500 hover:-translate-y-2">
                <div class="flex items-center gap-1 mb-4">
                  <svg class="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                  </svg>
                ...
                <p class="text-blue-100 leading-relaxed mb-6">
                  "Working with Sanket was a pleasure. He's professional, reliable, and always delivers 
                  high-quality solutions on time. Highly recommended!"
                </p>
                
                <div class="flex items-center gap-4">
                  <div class="w-12 h-12 bg-gradient-to-br from-cyan-500 to-sky-600 rounded-full flex items-center justify-center text-white font-bold">
                    SM
                  </div>
                  <div>
                    <div class="font-semibold text-white">Sarah Miller</div>
                    <div class="text-sm text-blue-200">CTO, InnovateLab</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="group" data-aos="zoom-in" data-aos-delay="300">
            <div class="relative">
              ...
              <div class="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/20 shadow-xl hover:shadow-green-500/25 transition-all duration-500 hover:-translate-y-2">
                <div class="flex items-center gap-1 mb-4">
                  <svg class="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                  </svg>
                ...
                <p class="text-blue-100 leading-relaxed mb-6">
                  "Sanket's technical skills and problem-solving abilities are outstanding. 
                  He transformed our business processes with innovative solutions."
                </p>
                ...
                <div class="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div class="text-sm text-blue-200">Director, DataFlow</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="text-center mt-16" data-aos="fade-up" data-aos-delay="400">
          <a routerLink="/contact" class="inline-flex items-center px-8 py-4 bg-white text-primary-600 font-semibold rounded-xl hover:bg-gray-50 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
            Work With Me

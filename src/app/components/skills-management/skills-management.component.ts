    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-900 via-slate-900 to-slate-950">
      ...
      <main class="container mx-auto px-4 py-8">
        ...
        <div *ngIf="showAddForm" class="mb-8">
          <div class="relative">
            <div class="absolute inset-0 bg-gradient-to-r from-blue-500/20 to-sky-500/20 rounded-2xl blur-lg"></div>
              ...
              <div class="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-2xl p-6 border border-white/20 shadow-xl hover:shadow-blue-500/25 transition-all duration-500 hover:-translate-y-2 group-hover:border-blue-400/50">
                ...
                <div class="mb-4">
                  ...
                  <div class="w-full bg-white/10 rounded-full h-2">
                    <div 
                      class="bg-gradient-to-r from-blue-400 to-sky-400 h-2 rounded-full transition-all duration-500"

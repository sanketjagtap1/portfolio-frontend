      ...
      <main class="container mx-auto px-4 py-8">
          ...
          <div class="bg-slate-800/80 backdrop-blur-lg rounded-xl shadow-xl border border-blue-400/30 p-6 hover:shadow-2xl transition-all duration-300">
            ...
            <div class="flex items-center justify-between">
              ...
              <button 
                ...
                class="px-3 py-1.5 bg-cyan-600 text-white text-sm rounded-lg hover:bg-cyan-700 transition-colors duration-200"
              >
                Manage
              </button>
            </div>
        ...
        <div class="bg-slate-800/80 backdrop-blur-lg rounded-xl shadow-xl border border-blue-400/30 p-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
                <div class="p-2 bg-sky-500/20 rounded-lg group-hover:bg-sky-500/30 transition-colors duration-200">
            ...
            <button 
              ...
              class="flex items-center gap-3 p-4 bg-slate-700/50 rounded-lg hover:bg-slate-700/70 transition-colors duration-200 group border border-slate-600/50"
            >
                <div class="p-2 bg-cyan-500/20 rounded-lg group-hover:bg-cyan-500/30 transition-colors duration-200">
...
export class AdminDashboardComponent implements OnInit {
  ...
  loadStats() {
    ...
    this.http.get(`${environment.apiBaseUrl}/api/portfolio/skills`)
      .subscribe({
        next: (skills: any) => {
    ...
    this.http.get(`${environment.apiBaseUrl}/api/portfolio/projects`)
      .subscribe({
        next: (projects: any) => {
    ...
    this.http.get(`${environment.apiBaseUrl}/api/portfolio/experience`)
      .subscribe({
        next: (experience: any) => {
    ...
    this.http.get(`${environment.apiBaseUrl}/api/blog`)
      .subscribe({
        next: (response: any) => {
    ...
    this.http.get(`${environment.apiBaseUrl}/api/portfolio/services`)
      .subscribe({
        next: (response: any) => {

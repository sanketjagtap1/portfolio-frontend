...
@Component({
  ...
  template: `
    <section id="experience" class="section bg-gradient-to-br from-slate-900 via-slate-900 to-slate-950 text-white relative overflow-hidden min-h-screen" role="region" aria-labelledby="experience-heading">
      <!-- Background Pattern -->
      ...
      <div class="container relative z-10 py-16">
        ...
        <div class="text-center mb-20" data-aos="fade-up">
          ...
          <div class="w-24 h-1 bg-gradient-to-r from-blue-400 to-cyan-400 mx-auto rounded-full mb-8"></div>
        ...
        <div *ngIf="!isLoading" class="relative max-w-5xl mx-auto" role="list" aria-label="Professional experience timeline">
          ...
          <div class="absolute left-4 md:left-8 top-0 bottom-0 w-1 bg-gradient-to-b from-blue-400 via-cyan-400 to-sky-400 rounded-full shadow-lg" aria-hidden="true"></div>
            ...
            >
              ...
              <div class="ml-12 md:ml-20">
                <div class="relative">
                  ...
                  <div class="absolute inset-0 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 rounded-2xl md:rounded-3xl blur-xl group-hover:blur-2xl transition-all duration-500"></div>
                  ...
                  <div class="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-2xl md:rounded-3xl p-6 md:p-8 border border-white/20 shadow-2xl hover:shadow-blue-500/25 transition-all duration-500 hover:-translate-y-2 group-hover:border-blue-400/50">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center gap-4 mb-6">
                      <div class="flex items-center gap-4">
                        <div class="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-br from-blue-500 to-cyan-600 rounded-xl md:rounded-2xl flex items-center justify-center shadow-lg">
                    ...
                    <div>
                      ...
                      <div class="flex flex-wrap gap-2 md:gap-3" role="list" aria-label="Technologies used">
                        <span *ngFor="let tech of exp.technologies" 
                              class="px-3 py-1.5 md:px-4 md:py-2 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 text-blue-200 rounded-lg md:rounded-xl text-xs md:text-sm font-medium border border-blue-400/30 hover:from-blue-500/40 hover:to-cyan-500/40 hover:border-blue-400/50 transition-all duration-300 hover:scale-105"
                              role="listitem">
                          {{ tech }}
                        </span>
                      </div>
              ...
              <div class="absolute left-2 md:left-6 top-6 md:top-8">
                <div class="relative">
                  <div class="w-4 h-4 md:w-6 md:h-6 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full border-2 md:border-4 border-slate-900 shadow-xl"></div>
                  <div class="absolute inset-0 w-4 h-4 md:w-6 md:h-6 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full animate-pulse"></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div *ngIf="!isLoading" class="mt-20 md:mt-32" data-aos="fade-up">
          <div class="text-center mb-12 md:mb-16">
            ...
            <div class="w-20 h-1 bg-gradient-to-r from-blue-400 to-cyan-400 mx-auto rounded-full"></div>
          </div>
          
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            <div class="group" data-aos="zoom-in" data-aos-delay="100">
              <div class="relative">
                <div class="absolute inset-0 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 rounded-xl md:rounded-2xl blur-lg group-hover:blur-xl transition-all duration-500"></div>
                <div class="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-xl md:rounded-2xl p-6 md:p-8 border border-white/20 shadow-xl hover:shadow-blue-500/25 transition-all duration-500 hover:-translate-y-2 group-hover:border-blue-400/50">
            ...
            <div class="group" data-aos="zoom-in" data-aos-delay="200">
              <div class="relative">
                <div class="absolute inset-0 bg-gradient-to-r from-cyan-500/20 to-sky-500/20 rounded-xl md:rounded-2xl blur-lg group-hover:blur-xl transition-all duration-500"></div>
                <div class="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-xl md:rounded-2xl p-6 md:p-8 border border-white/20 shadow-xl hover:shadow-cyan-500/25 transition-all duration-500 hover:-translate-y-2 group-hover:border-cyan-400/50">
            ...
            <div class="group" data-aos="zoom-in" data-aos-delay="300">
              <div class="relative">
                ...
                <div class="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-xl md:rounded-2xl p-6 md:p-8 border border-white/20 shadow-xl hover:shadow-green-500/25 transition-all duration-500 hover:-translate-y-2 group-hover:border-green-400/50">
                  <div class="text-3xl md:text-4xl mb-4">👥</div>
            ...
            <div class="group" data-aos="zoom-in" data-aos-delay="400">
              <div class="relative">
                ...
                <div class="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-xl md:rounded-2xl p-6 md:p-8 border border-white/20 shadow-xl hover:shadow-orange-500/25 transition-all duration-500 hover:-translate-y-2 group-hover:border-orange-400/50">
                  <div class="text-3xl md:text-4xl mb-4">🏗️</div>

    ...
    <div *ngIf="isOpen" class="fixed inset-0 z-50 overflow-y-auto" (click)="closeModal()">
      <div class="flex min-h-screen items-center justify-center p-4">
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl max-w-6xl w-full max-h-[95vh] overflow-hidden transform transition-all duration-300" (click)="$event.stopPropagation()">
          <!-- Header -->
          <div class="relative bg-gradient-to-r from-blue-600 via-cyan-600 to-sky-600 p-8 text-white">
          ...
          <div class="overflow-y-auto max-h-[calc(95vh-120px)]">
            ...
            <div class="p-8">
                ...
                <div class="flex flex-wrap gap-3">
                  <span 
                    *ngFor="let tech of project?.technologies"
                    class="px-4 py-2 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-full text-sm font-medium shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
                  >
                    {{ tech }}
                  </span>
                </div>
              ...
              <div class="mb-8">
                <div class="flex items-center gap-3 mb-6">
                  <div class="w-8 h-8 bg-gradient-to-r from-sky-500 to-blue-500 rounded-lg flex items-center justify-center">
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="flex flex-wrap gap-4">
                  ...
                  <a 
                    *ngIf="project?.liveUrl"
                    ...
                    target="_blank"
                    class="group flex items-center gap-3 px-6 py-4 bg-gradient-to-r from-blue-600 to-sky-600 text-white rounded-xl hover:from-blue-700 hover:to-sky-700 transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl"
                  >
                    <div class="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center group-hover:bg-white/30 transition-colors duration-200">

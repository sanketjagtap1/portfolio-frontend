      ...
      <section class="py-20 bg-gradient-to-br from-slate-900 via-slate-900 to-slate-950 text-white relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 text-center relative z-10">
          <div class="max-w-4xl mx-auto">
            <div class="inline-flex items-center gap-2 px-4 py-2 bg-sky-500/20 rounded-full text-sky-300 text-sm font-medium mb-6 border border-sky-400/30" data-aos="fade-up">
            ...
            <h2 class="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-white via-sky-100 to-cyan-200 bg-clip-text text-transparent" data-aos="fade-up" data-aos-delay="200">
              Ready to Work Together?
            </h2>
            
            <p class="text-xl text-sky-200 mb-8 max-w-3xl mx-auto leading-relaxed" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center" data-aos="fade-up" data-aos-delay="600">
              <a routerLink="/contact" class="inline-flex items-center px-8 py-4 bg-gradient-to-r from-sky-500 to-cyan-500 text-white font-semibold rounded-xl hover:from-sky-600 hover:to-cyan-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                Get In Touch
